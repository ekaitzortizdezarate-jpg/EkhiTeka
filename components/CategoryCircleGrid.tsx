        ...
        {categories.map((cat) => {
          ...
          return (
            <button
              ...
              className={`group relative rounded-xl sm:rounded-3xl overflow-hidden aspect-[4/3] sm:aspect-[16/10] lg:aspect-[16/9] flex items-center justify-center p-1.5 sm:p-5 text-center cursor-pointer transition-all duration-300 hover:scale-103 shadow-md border-2 ${
                isSelected
            ...
            >
              ...
              <div className="relative z-10 space-y-1 px-1 text-center">
                <span className="block font-serif font-black text-[11px] sm:text-base lg:text-lg text-white drop-shadow-md uppercase tracking-wider leading-tight">
                  {getCategoryName(cat)}
                </span>
                {isSelected && (
                  <span className="inline-block px-2 py-0.5 rounded-full bg-[#FFE259] text-[#1D1D1B] text-[8px] sm:text-[9px] font-sans font-black uppercase tracking-widest shadow-xs">
                    ✓
                  </span>
                )}
              </div>
