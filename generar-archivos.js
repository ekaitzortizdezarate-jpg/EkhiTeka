...
const files = {
  // 1. ACCIONES DE AUTENTICACIÓN (Declaraciones explícitas compatibles con el AST de Turbopack)
...
`,
  ...
  // 7. DICCIONARIO DE IDIOMAS (eu, es, en, fr)
...
export const translations: Record<Language, TranslationDict> = {
  eu: {
    ...
    exp_b1_desc: 'Ikasi artisau gaztak dastatzen Lekeition.',
    ...
    corp_hero_badge: 'Enpresa Irtenbideak',
    corp_hero_title: 'Enpresa',
    corp_hero_title_highlight: 'Opariak',
    corp_hero_desc: 'Lote gastronomiko artisauekin zure bezeroei eskerrak eman.',
    corp_whatsapp_btn: 'Eskatu Enpresa Aurrekontua',
    corp_card1_title: 'Gabonetako Loteak eta Saskiak',
    corp_card1_desc: 'Tartekaririk gabeko konposizio premiumak.',
    corp_card2_title: 'Dastaketa Pribatuak & Team Building',
    corp_card2_desc: 'Enpresa ekitaldiak eta talde jarduera gidatuak.',
    corp_card3_title: 'Pertsonalizazioa Zure Markarekin',
    corp_card3_desc: 'Faja pertsonalizatuak eta enpresaren logotipoa.',
    corp_logistics_badge: 'EkhiTeka Konpromisoa',
    corp_logistics_title: 'Logistika Bikaina',
    corp_logistics_desc: 'Langile edo bezeroen helbideetara 24/48 ordutan bidalketak.',
    ...
    orders_subtitle_buyer: 'Zure erosketen jarraipena eta egoera.',
    orders_subtitle_seller: 'Bezeroen eskaerak kudeatu eta prestatu.',
    ...
    seller_events_subtitle: 'Aforoa eta bertaratuen kudeaketa.',
    ...
    seller_events_no_events: 'Ez duzu dastaketa presentzialik oraindik',
    seller_events_no_events_desc: 'Argitaratu dastaketa presentzial bat goiko menutik.',
    ...
    footer_club_desc: 'Denboraldiko gazta berriak eta cata esklusiboak.',
    footer_join_whatsapp: 'WhatsApp bidez sartu',
    footer_cheese_desc: 'Afilatutako gaztak eta artisau kontserbak.',
    ...
    shop_hero_desc: 'Egileak sinatutako gaztak eta Kantabriako altxorrak.',
    ...
    shop_visit_desc: 'Gure Lekeitioko gaztaterian dena duzu: 80 baino gehiago erreferentzia artisau gazta.',
  ...
  es: {
    ...
    seller_events_subtitle: 'Control de aforo y asistentes para catas en Lekeitio.',
    ...
    seller_events_no_events_desc: 'Publica una cata presencial desde el menú superior.',
    ...
    shop_hero_desc: 'Quesos afinados de autor y tesoros del Cantábrico.',
    ...
    shop_visit_desc: 'En nuestra quesería de Lekeitio lo tienes todo: más de 80 referencias de quesos artesanos.',
  ...
  en: {
    ...
    home_card3_desc: 'Home tasting kits, in-person tastings in Lekeitio and wedding tables.',
    ...
    seller_events_subtitle: 'Capacity control and attendee management for tastings in Lekeitio.',
    ...
    seller_events_no_events_desc: 'Publish an in-person tasting from the top menu.',
    ...
    shop_hero_desc: 'Author-aged cheeses and Cantabrian treasures.',
    ...
    shop_visit_desc: 'Our Lekeitio shop has over 80 references of aged artisan cheeses.',
  ...
  fr: {
    ...
    seller_events_subtitle: 'Contrôle de jauge et gestion des inscrits à Lekeitio.',
    ...
    seller_events_no_events: 'Vous n\\'avez pas encore créé de dégustation',
    seller_events_no_events_desc: 'Publiez une dégustation depuis le menu supérieur.',
    ...
    shop_hero_desc: 'Fromages affinés d\\'auteur et trésors du Cantabrique.',
    ...
    shop_visit_desc: 'Notre fromagerie de Lekeitio propose plus de 80 références de fromages artisanaux.',
...
console.log('\n Archivos generados correctamente para Turbopack.');