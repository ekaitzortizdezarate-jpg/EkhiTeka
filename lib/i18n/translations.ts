...
export const translations: Record<Language, TranslationDict> = {
  eu: {
    ...
    deliv_pickup_address: 'Dendaren helbidea: Kale Nagusia 14, Bilbao',
  ...
  es: {
    ...
    deliv_pickup_address: 'Dirección de la tienda: Gran Vía 14, Bilbao',
  ...
  en: {
    ...
    deliv_pickup_address: 'Store Address: Gran Via 14, Bilbao',
  ...
  fr: {
    ...
    deliv_pickup_address: 'Adresse boutique : Gran Via 14, Bilbao',
